...
namespace ResinaSoft_WinForm
{
    class Card_person
    {
        ...
        public Card_person(Person person)
        {
            _person = person;
            btn_name = $"{_person.Id.ToString()} - { _person.Name} { _person.LastName}";
        }
        ...
        public Panel get_panel()
        {
            ...
            this.btn_card.FlatAppearance.BorderColor = System.Drawing.Color.FromArgb(((int)(((byte)(75)))), ((int)(((byte)(126)))), ((int)(((byte)(184)))));
            this.btn_card.Location = new System.Drawing.Point(5, 5);
            this.btn_card.Font = new System.Drawing.Font("Century Gothic", 10F);
